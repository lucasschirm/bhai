...
- **Field names match the spec verbatim** for MCP wire-compatibility (§ 9.1: a BHAI tool definition _is_ an MCP `Tool`). Do not rename or reorder optionality without a spec change.
